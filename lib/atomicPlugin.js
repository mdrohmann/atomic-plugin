...
AtomicPlugin.prototype.apply = function(compiler) {
    ...
    compiler.plugin("emit", function(compilation, callback) {
        var finalConfig = atomizer.getConfig(self.foundClasses, self.configObject.configs || {});
        var cssString = atomizer.getCss(finalConfig, self.configObject.options || {});
